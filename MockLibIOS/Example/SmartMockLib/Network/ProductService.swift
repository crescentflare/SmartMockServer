...
class ProductService {
    ...
    func loadProducts(_ success: @escaping ([Product]) -> Void, failure: @escaping (ApiError?) -> Void) {
    ...
    func loadProduct(_ productId: String, success: @escaping (Product) -> Void, failure: @escaping (ApiError?) -> Void) {
